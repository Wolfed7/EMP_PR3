...
public class SparseMatrix
{
   ...
   public SparseMatrix(int size, int offDiagonalElementsCount)
   {
      Size = size;
      _ia = new int[size + 1];
      _ja = new int[offDiagonalElementsCount];
      _al = new double[offDiagonalElementsCount];
      _au = new double[offDiagonalElementsCount];
      _di = new double[size];
   }
